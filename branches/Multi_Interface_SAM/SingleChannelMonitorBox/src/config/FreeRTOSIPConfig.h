...
extern uint8_t ipconfigUSE_DHCP;
...
#define ipconfigICMP_TIME_TO_LIVE		128
...
#define ipconfigFTP_TX_BUFSIZE				( 2 * ipconfigTCP_MSS )
#define ipconfigFTP_TX_WINSIZE				( 2 )
#define ipconfigFTP_RX_BUFSIZE				( 2 * ipconfigTCP_MSS )
