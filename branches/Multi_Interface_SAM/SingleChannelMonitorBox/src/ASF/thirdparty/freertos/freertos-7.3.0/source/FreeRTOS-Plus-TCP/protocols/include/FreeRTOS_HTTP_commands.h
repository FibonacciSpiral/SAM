...
void xFree_Web_Post_Container(struct xWeb_Post_Container * container);

#define MAX_SIZE_OF_SETTINGS 450
#define SETTINGS_DIR "/websrc/settings.json"

#define DHCP_CONTROL    "rbDHCP"
#define IP_ADDRESS		"ip_addr"
#define SUBNET_MASK		"submask"
#define GATEWAY_ADDR	"gw_addr"
#define PRIMARY_DNS		"pdns_addr"
#define SECONDARY_DNS	"sdns_addr"
