...
function initializeHome(json) { //need to make separate initializer for each page
    ...
    document.getElementById("ipv6_addr").innerHTML = json["ipv6_addr"].replace(/\./g, ":");
}
...
function initializeNetPage(json) {
    ...
    if(json["ipv6_setting"] == "disable")
    {
        document.getElementById("disable_ipv6").checked = true;
    }
    else if (json["ipv6_setting"] == "dhcp") 
    {
        document.getElementById("ipv6_dhcp").checked = true;
    } 
    else if (json["ipv6_setting"] == "static") 
    {
    ...
    document.getElementById("ipv6_addr").value = json["ipv6_addr"];
    document.getElementById("prefix_len").value = json["prefix_len"];
    document.getElementById("ipv6_gateway").value = json["ipv6_gateway"];
